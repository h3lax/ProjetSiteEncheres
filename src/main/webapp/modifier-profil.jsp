...
<header class="En-tête">
	...
	<h1>Mon profil</h1>
		<form action="modifier-profil" method="post">
			...
			<label for="prenom">Prénom : </label><input type="text" id="prenom" name="prenom" maxlength="30"value="${utilisateur.prenom}">
			<label for="telephone">Téléphone :</label><input type="tel" id="telephone" name="telephone" maxlength="15"value="${utilisateur.telephone}">
			<label for="codePostal">Code Postal :</label><input type="text" id="codePostal" name="codePostal" maxlength="10"value="${utilisateur.codePostal}">
			...
			<div>
			<label for="nom">Nom :</label><input type="text" id="nom" name="nom" maxlength="30"value="${utilisateur.nom}">
			<label for="email">Email :</label><input type="email" id="email" name="email" maxlength="20"value="${utilisateur.email}">
			<label for="rue">Rue :</label><input type="text" id="rue" name="rue" maxlength="30"value="${utilisateur.rue}">
			<label for="ville">Ville :</label><input type="text" id="ville" name="ville" maxlength="30"value="${utilisateur.ville}">
